...
//name=&adresse=&telephone=&password=&email=&description=
        ...
        String insertTableSQL =" UPDATE SUPPLIERS SET nomsupp=?, adressesupp=? , telephone=? , email=? , description=? WHERE idsupp=?";
        ...
        PreparedStatement pst = cnx.prepareStatement(insertTableSQL);
         ...
         pst.setString(1,request.getParameter("name") );
            pst.setString(2,request.getParameter("adresse"));
                   pst.setString(4,request.getParameter("email") );
            pst.setString(3,request.getParameter("telephone"));
           
            pst.setString(5,request.getParameter("description"));
            int idsupp=Integer.parseInt(request.getParameter("numero"));
            pst.setInt(6,idsupp );
