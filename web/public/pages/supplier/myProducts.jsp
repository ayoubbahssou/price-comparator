		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-edit"></i>My products
							</div>
                ...
                <% try {
                    ...
                    int idsupp=1;
                    PreparedStatement stat=cnx.prepareStatement("SELECT idprod,nomprod,prixprod from products where iddsupp="+session.getAttribute("idsupp"));
                    ResultSet rs=stat.executeQuery();
                    while(rs.next()){ %>
                        <tr>
                                    <% String url="editProduct.jsp?id="+rs.getString("idprod");%>
