<%-- 
    Document   : 200add.jsp
    Created on : Dec 12, 2015, 1:43:38 PM
    Author     : ayoub
--%>
...
//name=&adresse=&telephone=&password=&email=&description=
        ...
        String insertTableSQL = "INSERT INTO producs VALUES (?,?,?,?)";
        ...
        pst.setInt(4,num);      
         pst.setString(2,request.getParameter("name") );
            pst.setString(3,request.getParameter("adresse"));
                   pst.setString(4,request.getParameter("email") );
            pst.setString(5,request.getParameter("telephone"));
            pst.setString(6,request.getParameter("password"));
            pst.setString(7,request.getParameter("description"));
